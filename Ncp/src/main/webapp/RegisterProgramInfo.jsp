			...
			<form action="/programs" method="post">
				<section>
					<div>
							...
							<table>
								<tbody>
									...
									<tr>
										...
										<th>이수시간</th>
										<td><select id="completation_time"
						...
						<div>
							<table>
								<tbody>
									...
									<tr>
										<th>반영률</th>
										<td><input id="TALENT_capability_01" type="text"
											name="TALENT_capability_01" /></td>
										<td><input id="TALENT_capability_02" type="text"
											name="TALENT_capability_02" /></td>
										<td><input id="TALENT_capability_03" type="text"
											name="TALENT_capability_03" /></td>
										<td><input id="TALENT_capability_04" type="text"
											name="TALENT_capability_04" /></td>
										<td><input id="TALENT_capability_05" type="text"
											name="TALENT_capability_05" /></td>
										<td><input id="TALENT_capability_06" type="text"
											name="TALENT_capability_06" /></td>
									</tr>
								</tbody>
							</table>
						</div>
						...
						<div class="btnArea">
							<input id="btnRegister" type="submit" class="btnRegister"
								value="등록" />
						</div>
					</div>
				</section>
